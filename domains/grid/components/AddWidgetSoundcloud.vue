  ...
  try {
    ...
    if (isEdit.value) {
      ...
      const newWidget: GridWidgetWithoutCords = {
        type: GRID_WIDGET_TYPE.SOUNDCLOUD,
        w: 1,
        h: 1,
        i: generateItemId(),
        properties,
  ...
  <div class="p-6">
    <div class="flex items-center gap-3 pb-4">
      ...
      <div class="heading-inter-21-semi-bold">
        {{ formatMessage('add_widget_soundcloud_title') }}
      </div>
    </div>
    <div class="paragraph-inter-14-regular pb-6">
      {{ formatMessage('add_widget_soundcloud_description') }}
    </div>
    ...
    <lukso-textarea
      is-full-width
      autofocus
      :placeholder="formatMessage('add_widget_soundcloud_input_placeholder')"
      :value="inputValue"
      :error="inputError"
