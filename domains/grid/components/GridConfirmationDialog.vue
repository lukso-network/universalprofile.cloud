...
<template>
  <div
    v-if="hasUnsavedGrid"
    class="paragraph-inter-12-regular fixed bottom-10 left-[calc(50%-250px)] flex w-[500px] items-center justify-between gap-4 rounded-8 border-[3px] border-yellow-55 bg-neutral-100 p-4"
  >
