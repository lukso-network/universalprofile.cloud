...
describe('Instagram Parser', () => {
  describe('Instagram post', () => {
    it('can parse into Instagram post from post URL without params', async () => {
      const input = 'https://www.instagram.com/p/C98OXs6yhAq'
    ...
    it('can parse into Instagram post from post URL with params', async () => {
      const input =
    ...
    it('can parse into Instagram post from post embed code', async () => {
      const input =
  ...
  describe('Instagram reel', () => {
    it('can parse into Instagram reel from reel URL without params', async () => {
      const input = 'https://www.instagram.com/reel/DAlOgHkuyxd'
      const result = await parsePlatformInput(
        GRID_WIDGET_TYPE.Enum.INSTAGRAM,
        input
      )
    ...
    it('can parse into Instagram reel from reel URL with params', async () => {
      const input =
    ...
    it('can parse into Instagram reel from reel embed code', async () => {
      const input =
